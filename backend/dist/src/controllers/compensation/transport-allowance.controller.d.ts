import { TransportApprovalApproveDto, TransportApprovalRejectDto } from 'src/dto/transport-allowance-approval.dto';
import { FinanceCommentDto } from 'src/dto/payroll-approval.dto';
import { TransportAllowanceService } from 'src/services/compensation/transport-allowance.service';
export declare class TransportAllowanceController {
    ...
    listSettings(user: any, entity?: string, transportLevel?: string, page?: string, limit?: string): Promise<{
        status: number;
    ...
    approveApproval(id: string, body: TransportApprovalApproveDto, user: any): Promise<{
        status: number;
        message: string;
    }>;
    rejectApproval(id: string, body: TransportApprovalRejectDto, user: any): Promise<{
        status: number;
        message: string;
    }>;
