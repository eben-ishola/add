...
const transport_allowance_approval_dto_1 = require("../../dto/transport-allowance-approval.dto");
...
const TRANSPORT_ALLOWANCE_VIEW_PERMISSIONS = [
...
let TransportAllowanceController = class TransportAllowanceController {
    ...
    listSettings(user, entity, transportLevel, page, limit) {
    ...
    getWorkflowConfigs(user, entity) {
        return this.transportAllowanceService.getWorkflowConfigs(entity, user);
    }
    saveWorkflowConfig(payload) {
        return this.transportAllowanceService.saveWorkflowConfig(payload);
    }
    upsert(payload, user) {
        return this.transportAllowanceService.upsert(payload, user);
    }
    preview(payload, user) {
        return this.transportAllowanceService.preview(payload, user);
    }
    generate(payload, user) {
        return this.transportAllowanceService.generate(payload, user);
    }
    submit(payload, user) {
    ...
    approveApproval(id, body, user) {
        return this.transportAllowanceService.approveApproval(id, user, body?.comment);
    }
    rejectApproval(id, body, user) {
        return this.transportAllowanceService.rejectApproval(id, user, body?.reason);
    }
    markPosted(id, user) {
    ...
    switchAccount(id, body, user) {
        ...
        if (applyToAll) {
            return this.transportAllowanceService.switchApprovalAccountForAll(user, id, body?.accountType ?? '');
        }
        return this.transportAllowanceService.switchApprovalAccount(user, id, body?.staffId ?? body?.employeeId ?? '', body?.accountType ?? '');
    }
    updateFinanceComment(id, body, user) {
        return this.transportAllowanceService.updateFinanceComment(id, user, body?.comment);
    }
...
__decorate([
    ...
    __param(0, (0, user_decorator_1.UserOne)()),
    __param(1, (0, common_1.Query)('entity')),
    __param(2, (0, common_1.Query)('transportLevel')),
...
__decorate([
    (0, authorization_decorator_1.RequirePermissions)(TRANSPORT_ALLOWANCE_VIEW_PERMISSIONS),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, transport_allowance_approval_dto_1.TransportApprovalApproveDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __param(2, (0, user_decorator_1.UserOne)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, transport_allowance_approval_dto_1.TransportApprovalRejectDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TransportAllowanceController.prototype, "switchAccount", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:returntype", void 0)
], TransportAllowanceController.prototype, "updateFinanceComment", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
