...
const announcement_controller_1 = require("../controllers/comms/announcement.controller");
...
exports.AnnouncementModule = AnnouncementModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: announcement_schema_1.Announcement.name, schema: announcement_schema_1.AnnouncementSchema }]),
        ],
