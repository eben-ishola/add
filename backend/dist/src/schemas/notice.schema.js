...
], Notice.prototype, "userId", void 0);
__decorate([
...
exports.NoticeSchema.index({ userId: 1, read: 1, createdAt: -1 });
exports.NoticeSchema.index({ userId: 1, type: 1, createdAt: -1 });
exports.NoticeSchema.index({ createdAt: -1 });
